...
// stories content wrapper 
  ...
  if (isset($attribute['icons']) && $attribute['icons'] == "YES") {
    ...
    $ctl_html .= '<div  data-aos="'. $ctl_animation.'"  id="story-' . esc_attr($post->ID) . '" class="timeline-content  clearfix ' .esc_attr($even_odd) . '  ' . esc_attr($container_cls) .' '.esc_attr($design).'-content '.$stop_ani.'">';
