...
<div <?php post_class(ex_wptl_lightbox($full_content,$ID,'class'));?> id="wpextt_content-<?php echo get_the_ID();?>" style=" <?php echo $bg_style;?>" <?php echo ex_wptl_lightbox($full_content,$ID,'data'); ?>>
    ...
    <div class="wpex-timeline-label">
        ...
        <div class="timeline-details">
            ...
            <?php 
			if($full_content!='1'){?>
            <div class="wptl-readmore"><a href="<?php echo $custom_link;?>" title="<?php the_title_attribute();?>"><?php echo exwptl_get_option('exwptl_text_ct','exwptl_advanced_options')!='' ? exwptl_get_option('exwptl_text_ct','exwptl_advanced_options') : esc_html__('Continue reading','wp-timeline');?></a></div>
            <?php }?>
        </div>
